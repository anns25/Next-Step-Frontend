...
import { companyLoginSchema } from "@/lib/validation/companyAuthSchema";
...
const Login = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        e.preventDefault();
        setErrors({});
        const result = safeParse(companyLoginSchema, { email: formValues.email, password: formValues.password });
        if (!result.success) {
                ...
                >
                    <Box sx={{ width: "100%", maxWidth: 350 }}>
                        ...
                        <Typography variant="body2" mt={2}>
                            ...
                            <Link href="/company/signup" underline="hover">
                                Sign Up
                            </Link>
                        </Typography>
                        <Typography variant="body2" mt={2}>
